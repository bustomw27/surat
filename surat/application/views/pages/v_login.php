...
<html lang="en">
    <head>
        ...
        <meta name="description" content="MANAGEMENT SURAT" />
        <meta name="author" content="Bustomi Wildan" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"><img src="<?= base_url();?>assets/assets/img/logona.png"></h3></div>
                                    <div class="card-body">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="align-items-center justify-content-between small">
                            <center><div class="text-muted">Copyright &copy; Management Surat</div></center>
                        </div>
                    </div>
                </footer>
            </div>
